...
public class AltaTicketMedico extends HttpServlet {
	private static final long serialVersionUID = 1L;
       
    public AltaTicketMedico() {
        super();
    }
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
        ...
        try {
            ...
            String apellidoMed = med[0].trim();
            String nombreMed = med[1].trim();
            ResultSet rs = stmt.executeQuery("SELECT med_IdMedico FROM Medicos WHERE med_Apellido = '" + apellidoMed + "' AND med_Nombre = '" + nombreMed + "'");
            while (rs.next()) {
            	idMedico = rs.getInt("med_IdMedico");
            }
            ...
            stmt.executeUpdate("INSERT INTO Tickets (tic_IdTipoTicket, tic_IdEstacionamiento, tic_IdTipoVehiculo, tic_IdUsuarioSanatorio, tic_FechaHoraIngreso, tic_FechaHoraEgreso, " + 
            				   ...
            				   "tic_DNIPaciente, tic_NroEncuentroPaciente, tic_SuitePaciente, tic_MarcaVehiculo, tic_IdMedico, tic_NhcPaciente, tic_Estado, tic_Excedido) VALUES (2, " + idEstacionamiento + ", " + idVehiculo + ", " + 
            				   idUsuarioSanatorio + ", '" + fechaIngreso + "', NULL, " + idUsuario + ", '" + fechaSistema + "', NULL, NULL, '" + nroPatente + "', NULL, NULL, NULL, NULL, NULL, "+
            				   "NULL, NULL, " + idMedico + ", NULL, " + estadoTicket + ", " + excedido + ")");
		...
		util.loggear("TICKET PARA MÉDICO", "INGRESO DE TICKET", usuario, sanatorio); // LOG
