...
public class EditarMedico extends HttpServlet {
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {	
		String idMedico = request.getParameter("idMedicoE");
		String dni = request.getParameter("dniE");
		String matriculaNacional = request.getParameter("matNacE");
        ...
        try {
            ...
            stmt.executeUpdate("UPDATE Medicos SET med_DNI = '" + dni + "', med_Nombre = '" + nombre + "', med_Apellido = '" + apellido + "', med_MatriculaNacional = '" + matriculaNacional + "' WHERE med_IdMedico = " + idMedico);
		...
		util.loggear("MEDICOS", "MODIFICACION DEL MÉDICO " + idMedico, usuario, sanatorio); // LOG
        
        PrintWriter out = response.getWriter();
        out.println("<script type=\"text/javascript\">");
        out.println("alert('Médico " + idMedico + " modificado correctamente');");
