...
public class AltaEstadoTicket extends HttpServlet {
	private static final long serialVersionUID = 1L;
       
    public AltaEstadoTicket() {
        super();
    }
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {	
        ...
        try {
            ...
            stmt.executeUpdate("INSERT INTO EstadosTickets (etk_Nombre) VALUES ('" + descEstado + "')");
		...
		util.loggear("ESTADOS DE TICKET", "ALTA", usuario, sanatorio); // LOG
