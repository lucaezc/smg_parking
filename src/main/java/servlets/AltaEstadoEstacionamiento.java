...
public class AltaEstadoEstacionamiento extends HttpServlet {
	private static final long serialVersionUID = 1L;
       
    public AltaEstadoEstacionamiento() {
        super();
    }
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {	
        ...
        try {
            ...
            stmt.executeUpdate("INSERT INTO EstadosEstacionamientos (estado_Nombre) VALUES ('" + descEstado + "')");
		...
		util.loggear("ESTADOS DE ESTACIONAMIENTO", "ALTA", usuario, sanatorio); // LOG
        
        PrintWriter out = response.getWriter();
        out.println("<script type=\"text/javascript\">");
        out.println("alert('Estado agregado correctamente');");
