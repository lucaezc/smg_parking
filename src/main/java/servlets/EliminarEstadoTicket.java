...
public class EliminarEstadoTicket extends HttpServlet {
	private static final long serialVersionUID = 1L;
       
    public EliminarEstadoTicket() {
        super();
    }
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {	
        ...
        try {
            ...
            stmt.executeUpdate("DELETE EstadosTickets WHERE etk_IdEstadoTicket = " + idEstado);
		...
		util.loggear("ESTADOS DE TICKET", "ELIMINACION DEL ESTADO DE TICKET " + idEstado, usuario, sanatorio); // LOG
