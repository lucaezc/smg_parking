...
public class EliminarEstacionamiento extends HttpServlet {
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {	
		String idEst = request.getParameter("idEstE");
        ...
        try {
            ...
            stmt.executeUpdate("DELETE Estacionamientos WHERE est_IdEstacionamiento = " + idEst);
		...
		util.loggear("ESTACIONAMIENTOS", "ELIMINACION DEL ESTACIONAMIENTO " + idEst, usuario, sanatorio); // LOG
        
        PrintWriter out = response.getWriter();
        out.println("<script type=\"text/javascript\">");
        out.println("alert('Estacionamiento eliminado correctamente');");
