...
public class EliminarMedico extends HttpServlet {
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {	
		String idMedico = request.getParameter("idMedicoD");
        ...
        try {
            ...
            stmt.executeUpdate("DELETE Medicos WHERE med_IdMedico = " + idMedico);
		...
		util.loggear("MEDICOS", "ELIMINACION DE MEDICO " + idMedico, usuario, sanatorio); // LOG
        
        PrintWriter out = response.getWriter();
        out.println("<script type=\"text/javascript\">");
        out.println("alert('Médico eliminado correctamente');");
