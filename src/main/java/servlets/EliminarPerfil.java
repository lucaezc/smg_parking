...
public class EliminarPerfil extends HttpServlet {
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {	
		String idPerfilE = request.getParameter("idPerfilE");
        ...
        try {
            ...
            stmt.executeUpdate("DELETE Perfiles WHERE per_IdPerfil = " + idPerfilE);
		...
		util.loggear("PERFILES", "ELIMINACION DE PERFIL " + idPerfilE, usuario, sanatorio); // LOG
        
        PrintWriter out = response.getWriter();
        out.println("<script type=\"text/javascript\">");
        out.println("alert('Perfil eliminado correctamente');");
