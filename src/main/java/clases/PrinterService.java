...
public class PrinterService implements Printable {
	...
	public String printerName = util.getPrinter();
	...
	public void imprimirCabecera() {
		printBytes(TXT_2HEIGHT);
		printBytes(TXT_2WIDTH);
		printBytes(TXT_ALIGN_CT);
		printBytes("SMG PARKING".getBytes());
		printBytes(TXT_NORMAL);
		printBytes(TXT_ALIGN_LT);
		printBytes(CTL_LF);	
		printBytes(CTL_LF);		
	}
	
	public void imprimirTexto(String texto) {
		printBytes(texto.getBytes());
	}
	
	public void cortarPapel() {
		printBytes(PAPER_FULL_CUT);
	}
	...
	public void letraNegritaON() {
		printBytes(TXT_BOLD_ON);
	}
	
	public void letraNegritaOFF() {
		printBytes(TXT_BOLD_OFF);
	}
	
	public void letraSmall() {
		printBytes(TXT_SMALL);
	}
