...
<head>
	...
	<title>ABM Estados de Tickets</title>
	...
	<script src="js/abm_estadosTickets.js"></script>

</head>

<body>
    <jsp:include page="/servlets/GetEstadosTickets"/>
	<div class="container">
		<div class="table-wrapper">
			<div class="table-title">
				<div class="row">
					<div class="col-sm-6">
						<h2>ABM <b>Estados de Tickets</b></h2>
					</div>
	...
	<div id="agregarModal" class="modal fade">
		<div class="modal-dialog modal-dialog-centered">
			<div class="modal-content">
				<form action="/SMG_PARKING/servlets/AltaEstadoTicket" autocomplete="off">
					<div class="modal-header">
						<h4 class="modal-title">Agregar estado de ticket</h4>
	...
	<div id="editarModal" class="modal fade">
		<div class="modal-dialog modal-dialog-centered">
			<div class="modal-content">
				<form action="/SMG_PARKING/servlets/EditarEstadoTicket" autocomplete="off">
					<div class="modal-header">
						<h4 class="modal-title">Editar estado de ticket</h4>
						<button type="button" class="close" data-dismiss="modal" aria-hidden="true">&times;</button>
					</div>
					<div class="modal-body">
						<div class="form-group">
	...
	<div id="eliminarModal" class="modal fade">
		<div class="modal-dialog modal-dialog-centered">
			<div class="modal-content">
				<form action="/SMG_PARKING/servlets/EliminarEstadoTicket" autocomplete="off">
					<div class="modal-header">
						<h4 class="modal-title">Eliminar estado de ticket</h4>
						<button type="button" class="close" data-dismiss="modal" aria-hidden="true">&times;</button>
					</div>
					<div class="modal-body">
						<p class="text-danger">¿Está seguro de querer eliminar el estado de ticket?</p>
